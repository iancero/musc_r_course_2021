...
```{r, echo=FALSE, fig.align='center', fig.cap="https://cran.r-project.org/", out.width = '66%'}
...
```{r, echo=FALSE, fig.align='center', fig.cap="https://www.rstudio.com/products/rstudio/download/", out.width = '66%'}
